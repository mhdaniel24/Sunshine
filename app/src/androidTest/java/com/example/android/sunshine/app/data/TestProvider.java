...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, Long.toString(testDate)));
    ...
    public void testInsertReadProvider() {
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithStartDate(
                        TestUtilities.TEST_LOCATION, Long.toString(TestUtilities.TEST_DATE)),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithDate(TestUtilities.TEST_LOCATION, Long.toString(TestUtilities.TEST_DATE)),
                null,
                null,
                null,
                null
